...
export function FinalScoreModal(): React.ReactElement | null {
  ...
  useEffect(() => {
    ...
    if (!handled.current) {
      ...
      const rank = loadChallengeRuns().findIndex((r) => r.score <= score.total) + 1;
    ...
    <div className="intro-backdrop">
      <div className="intro-card">
        ...
        <p style={{ margin: '8px 0', fontSize: 28, fontWeight: 700 }}>
          {s.total} <span className="muted" style={{ fontSize: 14 }}>/ 1000 · #{result.rank} on your leaderboard</span>
        </p>
