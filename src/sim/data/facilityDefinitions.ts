...
export const FACILITY_DEFS: Record<FacilityDefId, FacilityDefinition> = {
  ...
  farm: {
    ...
    workerCapacity: 5,
    storageCapacity: 200,
    allowedRecipes: ['grow_grain'],
    allowedProductsForSale: [],
    footprint: 4,
    description: 'Grows grain. Needs workers; no inputs required.',
  },
  mine: {
    id: 'mine',
    name: 'Mine',
    ...
    maintenanceCostPerDay: dollars(25),
    workerCapacity: 6,
    storageCapacity: 200,
  ...
  factory: {
    ...
    maintenanceCostPerDay: dollars(22),
    workerCapacity: 6,
    storageCapacity: 240,
    allowedRecipes: ['bake_bread', 'make_tools'],
    allowedProductsForSale: [],
    footprint: 4,
    description:
      'Manufactures goods from inputs. Can bake bread or make tools depending on the selected recipe.',
  },
  warehouse: {
    id: 'warehouse',
    name: 'Warehouse',
    ...
    maintenanceCostPerDay: dollars(10),
    workerCapacity: 2,
    storageCapacity: 600,
    allowedRecipes: [],
    allowedProductsForSale: [],
  ...
  retail: {
    ...
    maintenanceCostPerDay: dollars(20),
    workerCapacity: 4,
    storageCapacity: 160,
    allowedRecipes: [],
    allowedProductsForSale: ['bread', 'tools'],
    footprint: 3,
  ...
  importer: {
    ...
    allowedRecipes: ['import_grain', 'import_minerals'],
    allowedProductsForSale: [],
    footprint: 4,
